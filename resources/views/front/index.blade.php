...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
        ...
        CSS
        ============================================= -->
        <link rel="stylesheet" href="{{asset('jobs/css/linearicons.css')}}">
        <link rel="stylesheet" href="{{asset('jobs/css/font-awesome.min.css')}}">
        <link rel="stylesheet" href="{{asset('jobs/css/bootstrap.css')}}">
        <link rel="stylesheet" href="{{asset('jobs/css/magnific-popup.css')}}">
        <link rel="stylesheet" href="{{asset('jobs/css/nice-select.css')}}">					
        <link rel="stylesheet" href="{{asset('jobs/css/animate.min.css')}}">
        <link rel="stylesheet" href="{{asset('jobs/css/owl.carousel.css')}}">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="{{asset('jobs/js/vendor/jquery-2.2.4.min.js')}}"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
        <script src="{{asset('jobs/js/vendor/bootstrap.min.js')}}"></script>			
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
          <script src="{{asset('jobs/js/easing.min.js')}}"></script>			
        <script src="{{asset('jobs/js/hoverIntent.js')}}"></script>
        <script src="{{asset('jobs/js/superfish.min.js')}}"></script>	
        <script src="{{asset('jobs/js/jquery.ajaxchimp.min.js')}}"></script>
        <script src="{{asset('jobs/js/jquery.magnific-popup.min.js')}}"></script>	
        <script src="{{asset('jobs/js/owl.carousel.min.js')}}"></script>			
        <script src="{{asset('jobs/js/jquery.sticky.js')}}"></script>
        <script src="{{asset('jobs/js/jquery.nice-select.min.js')}}"></script>			
        <script src="{{asset('jobs/js/parallax.min.js')}}"></script>		
        <script src="{{asset('jobs/js/mail-script.js')}}"></script>	
